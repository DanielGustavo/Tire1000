...
export function Hero({ onSignUp }: { onSignUp: () => void }) {
  return (
    <section className="relative flex w-full flex-col items-center gap-8 overflow-clip p-4 lg:p-10">
      ...
      <img
        src={logo}
        alt="Tire 1000"
        className="relative h-[213px] w-[238px] object-contain lg:h-[276px] lg:w-[309px]"
      />
      ...
      <Button variant="primary" className="relative lg:h-16" onClick={onSignUp}>
